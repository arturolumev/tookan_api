...
// get_job_details_by_order_id(payloadCheckById)
...
//         const order_id = pedido.order_id ? pedido.order_id.toString() : '';
//         const nombre_producto = pedido.nombre_producto ? pedido.nombre_producto.toString() : '';
//         const precio_unitario = pedido.precio_unitario ? pedido.precio_unitario.toString() : '';
//         const cantidad = pedido.cantidad ? pedido.cantidad.toString() : '';
//         const direccion_final = pedido.direccion_final ? pedido.direccion_final.toString() : '';
//         const descripcion = pedido.descripcion ? pedido.descripcion.toString() : '';
//         const direccion_referencia = pedido.direccion_referencia ? pedido.direccion_referencia.toString() : '';
//         const nombre_destinatario = pedido.nombre_destinatario ? pedido.nombre_destinatario.toString() : '';
//         const telefono_comprador = pedido.telefono_comprador ? pedido.telefono_comprador.toString() : '';
//         const job_pickup_datetime = formatDateTime(pedido.job_pickup_datetime);
//         // const telefono_comprador = processPhoneNumbers(pedido.telefono_comprador);
//         const email_comprador = pedido.email_comprador ? pedido.email_comprador : '';

//         // Crear el payload con los datos del pedido actual
// let payloadCreate = {
//   documento_origen: "SO" + order_id,
//   express: "",
//   rango: "Rango 1", //Puede tener los valores "Rango 1",  "Rango 2",  "Rango 3".
...
//   hora_deliv: "03/26/2024 14:00",
//   //  // Si es Rango 1 sería: 2024-03-04 14:00:00
//   //  // Si es Rango 2 sería: 2024-03-04 18:00:00
//   //  // Si es Rango 3 sería: 2024-03-04 20:00:00
//   ////////////////////////////////

//   order_id: "SO" + order_id,
//   job_description: "Prueba de pedido " + descripcion, // TASK DESCRIPCION
//   job_pickup_phone: telefono_comprador,
//   job_pickup_name: "Prueba de pedido " + nombre_destinatario,
//   job_pickup_email: email_comprador,
//   job_pickup_address: "Prueba de pedido " + direccion_final,
//   job_pickup_latitude: "30.7188978",
//   job_pickup_longitude: "76.810296",
//   // job_pickup_datetime: job_pickup_datetime,
//   job_delivery_datetime: job_pickup_datetime, // VARIA SEGUN EL RANGO 14, 18, 20
...
//         console.log("TOOKAN ID: ", payloadCreate.documento_origen);
...
//           await actualizarTookanID(payloadCreate.documento_origen, order_id);

//           console.log("Pedido creado y TookanID actualizado:", payloadCreate.documento_origen, order_id);
//         } else {
//           console.error("Error al crear la entrega: ", response);
//         }
//         // console.log("Respuesta de creación de entrega:", response);
//       } catch (error) {
//         console.error("Error al crear la entrega:", error);
//       }
//     }
